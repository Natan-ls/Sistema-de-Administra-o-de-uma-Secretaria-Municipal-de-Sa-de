...
public final class CaminhoFXML {
    ...
    public static final String VIEW_ADIMINISTRADOR = "/com/example/sistema_de_saude/views/viewAdiministrador/ViewAdiministrador.fxml";
    ...
    public static final String PANE_ATUALIZAR_TIPO_MEDICAMENTO = "/com/example/sistema_de_saude/views/viewFarmacia/PaneAtualizarTipoMedicamento.fxml";
